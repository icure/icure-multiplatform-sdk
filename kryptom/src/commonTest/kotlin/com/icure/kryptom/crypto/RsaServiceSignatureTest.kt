...
private val dataSamplesSignatures: Map<RsaAlgorithm.RsaSignatureAlgorithm, List<Pair<Pair<Int, Int>, String>>> = mapOf(
	PssWithSha256 to listOf(
		Pair(
			0,
			0
		) to "xseloLIBcNJe2kJ95eGSj78zfi88DR8HT0lzkC/cSItZ4yphrgxcDSNca/NGrBRGHD/NY6wJjvhslu53glUEX5l+LeyCscZTKp" +
		...
		Pair(
			1,
			0
		) to "yQMmEgCU4HDiZ1YPvptK3LTD83/IpIXN4t+M5t5GrbTbF3PdJFw1x64xCWExXROMLp2KoWaQcwxdITWrQqScij+euoKRueBGYB" +
		...
		Pair(
			2,
			0
		) to "fQI2AbxMPx5MmftBRfOe8Vk3/nTAsLl+7l1D3wiMd18vSKp/AoEUKSmLcpduvkRScvQbJJRepdoMfOm/EFjzyQHCee1w8mjw42" +
		...
		Pair(
			3,
			0
		) to "tk2p1HWxncYaHRIw7rqZsDJtIvUNNzvNQJgkn5qU3p2r2UjDWtWchHcsSRpOt2kp6cbQK59h7bvJTQTFDYU/to/JjASh0EdcWt" +
		...
		Pair(
			4,
			0
		) to "AQrV8rzZxvEZRNECtpZIVftam2exo+wJWIDshhVsB5OTZOeAzRkPjwDfZ5piiuDBGICDcxYncwCe0k4mJtqMlnoCoB8yXqlVxQ" +
		...
		Pair(
			5,
			0
		) to "lr/vcZqFYsVV5s4b5+ffVNTIU9PSsFYet2lyf1eM9PA+LKRGljVmTi/lI/FQL/uOoJAf87m/DpemCwfFoUzxiw5EDJAuVokTFF" +
		...
		Pair(
			0,
			1
		) to "QqlyjGrxbJrCGxwlZmb0mn0dlyIuhmjBUweKlxW3gZRAEKsruu7o6r+1C+XI4xp6bj4QVb7F5hkPe6WuZSa+zfJGirhZ3AUgxM" +
		...
		Pair(
			1,
			1
		) to "rSzgZ913ZvjXaxz+eqOMGuqr8bm92Vo0MdjlM41DFjfch9EUKC8vQvNwwsz0enWdOr80ySSGNLYIwoqfWnMf8EsNrPNUZPzxcX" +
		...
		Pair(
			2,
			1
		) to "WFn8WZ/8EOs+qCHVBdUYLiOuvI5f7SFOTqKBSBcM1N6g+2wZ1W84/bXepivdl8hKtVlUXtKnpYlzidDBblBH6qnfKyFzeiLrZF" +
		...
		Pair(
			3,
			1
		) to "PuysSeoeT8UpVTAaFRUCdn8p9l3YBBk86IGH9pz4dKSslx5MhbcHBVmJ2Izx1WrYXR7K8rjgAIhZg2wanuUzmZjX5/7o+naVh7" +
		...
		Pair(
			4,
			1
		) to "YmehOaCX2Qy/q5lDAyCBLA6dx3VmzrDVWW29KXX4XP7JMhPQSQSimPbiLCTQMRKaCC7u3sPX4c8ZsDMKpXURlAtVdwaYJGXkgV" +
		...
		Pair(
			5,
			1
		) to "G6eqDeT8TmO6Cp8W1if30ylFkZW8KuY44L5IskGrsDGFz8/wiUlGWNVUF86wiJr/KBYT28q0mRNatpAwiD9CY0aa+r55bcZfFz" +
