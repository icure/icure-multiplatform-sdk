...
import com.icure.sdk.serialization.HealthElementFilterSerializer
...
class RawHealthElementApiImpl(
...
) : BaseRawApi(httpClient, additionalHeaders, timeout), RawHealthElementApi {
	...
	override suspend fun matchHealthElementsBy(filter: AbstractFilter<HealthElement>): HttpResponse<List<String>> =
		post {
			...
			setAuthorizationWith(authService)
			contentType(ContentType.Application.Json)
			setBody(Serialization.json.encodeToString(HealthElementFilterSerializer, filter))
		}.wrap()
