...
import com.icure.sdk.serialization.MessageFilterSerializer
...
class RawMessageApiImpl(
...
) : BaseRawApi(httpClient, additionalHeaders, timeout), RawMessageApi {
	...
	override suspend fun matchMessagesBy(filter: AbstractFilter<Message>): HttpResponse<List<String>> =
		post {
			...
			setAuthorizationWith(authService)
			contentType(ContentType.Application.Json)
			setBody(Serialization.json.encodeToString(MessageFilterSerializer, filter))
		}.wrap()
