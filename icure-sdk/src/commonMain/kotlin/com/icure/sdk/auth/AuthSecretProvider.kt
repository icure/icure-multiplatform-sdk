...
interface AuthSecretProvider {
	 ...
	 * Usually the array contain also the [AuthenticationClass.LongLivedToken] element, but if the user is attempting to perform a sensitive operations
	 ...
	 * token for this operation, meaning the array will not contain the [AuthenticationClass.LongLivedToken] element.
	 *
	 ...
	 *
	 * ## [AuthenticationClass.TwoFactorAuthentication] secret type
	 *
	 * The [AuthenticationClass.TwoFactorAuthentication] secret type is only used when the user has 2fa enabled. In this case the SDK will call
	 ...
	 * valid password the SDK will immediately call this method again, this time containing the [AuthenticationClass.TwoFactorAuthentication]
	 ...
	 * cached, but it may contain the [AuthenticationClass.TwoFactorAuthentication] element instead.
	 *
