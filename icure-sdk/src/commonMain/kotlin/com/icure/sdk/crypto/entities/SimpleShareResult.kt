...
internal class SimpleShareResultSerializer<T : HasEncryptionMetadata>(private val valueSerializer: KSerializer<T>):
	...
	companion object {
		private val SUCCESS_QUALIFIED_NAME = "com.icure.sdk.crypto.entities.SimpleShareResult.Success"
		private val FAILURE_QUALIFIED_NAME = "com.icure.sdk.crypto.entities.SimpleShareResult.Failure"
	}
