...
@Serializable
public sealed interface Classification : StoredDocument, ICureDocument<String>, Encryptable {
...
public fun Classification.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                  ...
                                  return when(this) {
                                      is EncryptedClassification -> copy(id = id, rev = rev, created
      ...
      is DecryptedClassification -> copy(id = id, rev = rev, created = created, modified = modified,
