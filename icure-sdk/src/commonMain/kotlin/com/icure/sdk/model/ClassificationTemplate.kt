...
@Serializable
public sealed interface ClassificationTemplate : StoredDocument, ICureDocument<String>,
...
public fun ClassificationTemplate.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                      ...
                                      return when(this) {
                                          is DecryptedClassificationTemplate -> copy(id = id, rev =
          rev, created = created, modified = modified, author = author, responsible = responsible,
          ...
          securityMetadata)
      is EncryptedClassificationTemplate -> copy(id = id, rev = rev, created = created, modified =
