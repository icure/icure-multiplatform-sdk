...
data class DecryptedHealthElement(
    ...
    ): DecryptedHealthElement = copy(securityMetadata = securityMetadata, secretForeignKeys = secretForeignKeys)
    // endregion
}
...
data class EncryptedHealthElement(
    ...
    override fun copyWithSecurityMetadata(
        securityMetadata: SecurityMetadata,
        secretForeignKeys: Set<String>,
    ): EncryptedHealthElement = copy(securityMetadata = securityMetadata, secretForeignKeys = secretForeignKeys)
    // endregion
}
