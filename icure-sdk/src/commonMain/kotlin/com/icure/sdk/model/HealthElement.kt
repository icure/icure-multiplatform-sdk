...
@Serializable
public sealed interface HealthElement : StoredDocument, ICureDocument<String>, Encryptable {
...
public data class EncryptedHealthElement(
  ...
  override val plansOfAction: List<PlanOfAction> = emptyList(),
  override val episodes: List<Episode> = emptyList(),
  override val careTeam: List<CareTeamMember> = emptyList(),
...
public fun HealthElement.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                  ...
                                  return when(this) {
                                      is EncryptedHealthElement -> copy(id = id, identifiers =
      ...
      is DecryptedHealthElement -> copy(id = id, identifiers = identifiers, rev = rev, created =
