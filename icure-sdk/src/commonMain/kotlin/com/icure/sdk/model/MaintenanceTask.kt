...
@Serializable
public sealed interface MaintenanceTask : StoredDocument, ICureDocument<String>, Encryptable {
...
public fun MaintenanceTask.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                  ...
                                  return when(this) {
                                      is EncryptedMaintenanceTask -> copy(id = id, rev = rev,
      ...
      is DecryptedMaintenanceTask -> copy(id = id, rev = rev, identifier = identifier, created =
