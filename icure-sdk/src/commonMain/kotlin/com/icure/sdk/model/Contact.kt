...
@Serializable
public sealed interface Contact : StoredDocument, ICureDocument<String>, Encryptable {
...
public data class EncryptedContact(
  ...
  override val subContacts: Set<SubContact> = emptySet(),
  override val services: Set<Service> = emptySet(),
...
public fun Contact.copy(
  ...
  notes: List<Annotation> = this.notes,
                                  ...
                                  return when(this) {
                                      is EncryptedContact -> copy(id = id, rev = rev, created =
      ...
      is DecryptedContact -> copy(id = id, rev = rev, created = created, modified = modified, author
