...
@Serializable
public sealed interface IcureStub : ICureDocument<String>, Versionable<String>, Encryptable {
...
public data class EncryptedIcureStub(
  override val id: String,
...
public data class DecryptedIcureStub(
  override val id: String,
  override val rev: String? = null,
  override val created: Long? = null,
  override val modified: Long? = null,
...
public fun IcureStub.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                  ...
                                  return when(this) {
                                      is EncryptedIcureStub -> copy(id = id, rev = rev, created =
      ...
      is DecryptedIcureStub -> copy(id = id, rev = rev, created = created, modified = modified,
