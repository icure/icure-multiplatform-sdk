...
@Serializable
public sealed interface Form : StoredDocument, ICureDocument<String>, Encryptable {
...
public fun Form.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                  ...
                                  return when(this) {
                                      is EncryptedForm -> copy(id = id, rev = rev, created =
      ...
      is DecryptedForm -> copy(id = id, rev = rev, created = created, modified = modified, author =
