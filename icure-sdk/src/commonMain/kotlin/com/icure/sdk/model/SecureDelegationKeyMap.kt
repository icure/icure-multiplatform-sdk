...
public fun SecureDelegationKeyMap.copy(
  ...
  deletionDate: Long? = this.deletionDate,
                                  ...
                                  return when(this) {
                                      is EncryptedSecureDelegationKeyMap -> copy(id = id, rev = rev,
          delegationKey = delegationKey, delegator = delegator, delegate = delegate,
      ...
      is DecryptedSecureDelegationKeyMap -> copy(id = id, rev = rev, delegationKey = delegationKey,
