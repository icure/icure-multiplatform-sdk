...
data class DecryptedSecureDelegationKeyMap(
    ...
    ): DecryptedSecureDelegationKeyMap = copy(securityMetadata = securityMetadata, secretForeignKeys = secretForeignKeys)
    // endregion
}
...
data class EncryptedSecureDelegationKeyMap(
    ...
    override fun copyWithSecurityMetadata(
        securityMetadata: SecurityMetadata,
        secretForeignKeys: Set<String>,
    ): EncryptedSecureDelegationKeyMap = copy(securityMetadata = securityMetadata, secretForeignKeys = secretForeignKeys)
    // endregion
}
