...
@Serializable
public sealed interface Document : StoredDocument, ICureDocument<String>, Encryptable {
...
public fun Document.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                  ...
                                  return when(this) {
                                      is EncryptedDocument -> copy(id = id, rev = rev, created =
      ...
      is DecryptedDocument -> copy(id = id, rev = rev, created = created, modified = modified,
