...
@Serializable
public sealed interface Message : StoredDocument, ICureDocument<String>, Encryptable {
...
public fun Message.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                  ...
                                  return when(this) {
                                      is EncryptedMessage -> copy(id = id, rev = rev, created =
      ...
      is DecryptedMessage -> copy(id = id, rev = rev, created = created, modified = modified, author
