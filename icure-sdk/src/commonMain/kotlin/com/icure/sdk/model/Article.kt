...
@Serializable
public sealed interface Article : StoredDocument, ICureDocument<String>, HasEncryptionMetadata,
    Encryptable {
...
public fun Article.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                      ...
                                      return when(this) {
                                          is DecryptedArticle -> copy(id = id, rev = rev, created =
          ...
          deletionDate = deletionDate, name = name, content = content, classification =
          classification, secretForeignKeys = secretForeignKeys, cryptedForeignKeys =
      ...
      is EncryptedArticle -> copy(id = id, rev = rev, created = created, modified = modified, author
          = author, responsible = responsible, medicalLocationId = medicalLocationId, tags = tags,
          codes = codes, endOfLife = endOfLife, deletionDate = deletionDate, name = name, content =
          content, classification = classification, secretForeignKeys = secretForeignKeys,
