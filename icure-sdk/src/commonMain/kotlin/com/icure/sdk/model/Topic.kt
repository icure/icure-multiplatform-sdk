...
@Serializable
public sealed interface Topic : StoredDocument, ICureDocument<String>, Encryptable {
...
public fun Topic.copy(
  ...
  linkedServices: Set<String> = this.linkedServices,
                                  ...
                                  return when(this) {
                                      is EncryptedTopic -> copy(id = id, rev = rev, created =
          ...
          = linkedServices)
      is DecryptedTopic -> copy(id = id, rev = rev, created = created, modified = modified,
