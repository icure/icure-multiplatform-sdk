...
@Serializable
public sealed interface Patient : StoredDocument, ICureDocument<String>, Person, Encryptable,
    CryptoActor {
...
public data class EncryptedPatient(
  ...
  override val insurabilities: List<Insurability> = emptyList(),
  override val partnerships: List<Partnership> = emptyList(),
  override val patientHealthCareParties: List<PatientHealthCareParty> = emptyList(),
  override val financialInstitutionInformation: List<FinancialInstitutionInformation> = emptyList(),
  override val medicalHouseContracts: List<MedicalHouseContract> = emptyList(),
...
public fun Patient.copy(
  ...
  employementInfos: List<EmploymentInfo> = this.employementInfos,
                                  ...
                                  return when(this) {
                                      is EncryptedPatient -> copy(id = id, identifier = identifier,
          rev = rev, created = created, modified = modified, author = author, responsible =
          responsible, tags = tags, codes = codes, endOfLife = endOfLife, deletionDate =
          ...
          = employementInfos)
      is DecryptedPatient -> copy(id = id, identifier = identifier, rev = rev, created = created,
