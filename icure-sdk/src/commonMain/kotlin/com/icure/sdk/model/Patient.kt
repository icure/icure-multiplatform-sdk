...
data class DecryptedPatient(
    ...
    ): DecryptedPatient = copy(securityMetadata = securityMetadata, secretForeignKeys = secretForeignKeys)
    // endregion
}
...
data class EncryptedPatient(
    ...
    override fun copyWithSecurityMetadata(
        securityMetadata: SecurityMetadata,
        secretForeignKeys: Set<String>,
    ): EncryptedPatient = copy(securityMetadata = securityMetadata, secretForeignKeys = secretForeignKeys)
    // endregion
}
