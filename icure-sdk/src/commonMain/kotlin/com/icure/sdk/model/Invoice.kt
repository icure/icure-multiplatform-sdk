...
data class DecryptedInvoice(
    ...
    ): DecryptedInvoice = copy(securityMetadata = securityMetadata, secretForeignKeys = secretForeignKeys)
    // endregion
}
...
data class EncryptedInvoice(
    ...
    override fun copyWithSecurityMetadata(
        securityMetadata: SecurityMetadata,
        secretForeignKeys: Set<String>,
    ): EncryptedInvoice = copy(securityMetadata = securityMetadata, secretForeignKeys = secretForeignKeys)
    // endregion
}
