...
@Serializable
public sealed interface Invoice : StoredDocument, ICureDocument<String>, HasEncryptionMetadata,
    Encryptable {
...
public fun Invoice.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                      ...
                                      return when(this) {
                                          is DecryptedInvoice -> copy(id = id, rev = rev, created =
      ...
      is EncryptedInvoice -> copy(id = id, rev = rev, created = created, modified = modified, author
