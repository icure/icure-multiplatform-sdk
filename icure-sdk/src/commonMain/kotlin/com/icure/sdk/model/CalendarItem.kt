...
@Serializable
public sealed interface CalendarItem : StoredDocument, ICureDocument<String>, Encryptable {
...
public fun CalendarItem.copy(
  ...
  securityMetadata: SecurityMetadata? = this.securityMetadata,
                                  ...
                                  return when(this) {
                                      is EncryptedCalendarItem -> copy(id = id, rev = rev, created =
      ...
      is DecryptedCalendarItem -> copy(id = id, rev = rev, created = created, modified = modified,
