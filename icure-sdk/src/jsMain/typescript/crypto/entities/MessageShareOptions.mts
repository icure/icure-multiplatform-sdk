...
export class MessageShareOptions implements SimpleDelegateShareOptions {
  ...
  constructor(partial: Partial<MessageShareOptions> & Pick<MessageShareOptions, "requestedPermissions" | "shareEncryptionKey" | "sharePatientId" | "shareOwningEntityIds" | "shareSecretIds">) {
