...
class SingleSourcePageIteratorTest : StringSpec({
	...
	val firstPage = PaginatedList(
		...
		nextKeyPair = PaginatedDocumentKeyIdPair(startKey = "some key", startKeyDocId = "some id")
	)
	val secondPage = PaginatedList<Datum, JsonString>(rows = List(10) { Datum(someValue = it)})
