...
const val username = "tremaluca96+hbp@gmail.com"
const val password = "cddda412-b406-40e2-89ce-7f2358630403"

@Serializable
data class Pain(
	val pain1: String? = null,
	val pain15: String? = "", //
	val pain2: Boolean = false, //
	@EncodeDefault(EncodeDefault.Mode.NEVER)
	val pain3: List<String> = emptyList(),
	val pain4: List<String>? = null,
	val pain5: List<String>? = null, //
	val pain6: List<String?> = listOf("", null) //
)
