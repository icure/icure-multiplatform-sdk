...
val encryptedDataSamplesKeys = listOf(
    ...
    "11tOX7wIFvOUx/gxLD79db16mTfUANdZ",
...
val encryptedDataSamples = mapOf(
    ...
    Pair(0, 1) to "Yfp9eibllZVoVBaznalQ8MYQo7gbDX2ISIvr0/DOX2s=",
    Pair(0, 2) to "Yfp9eibllZVoVBaznalQ8KOY61DvQiD4f/bqSn0ZCPA=",
    Pair(1, 0) to "Yfp9eibllZVoVBaznalQ8I7lYVDCKDfYuSjWcGqbGYc8WAC3WTJEeeZu1mIwLY4V",
    Pair(1, 1) to "Yfp9eibllZVoVBaznalQ8JmpBqVAER88OQaO+oje+QZJuc4dIOY6Lit/lCSh0j/Y",
    Pair(1, 2) to "Yfp9eibllZVoVBaznalQ8KeasfbPCmhO9ouO8hBKTAz1dKEHakS9DaT/NE5jH4he",
    Pair(2, 0) to "Yfp9eibllZVoVBaznalQ8BiSJpO2ac/mRMbq/67pTFHwBOkxoq/NhDIDq2aXeilB",
    Pair(2, 1) to "Yfp9eibllZVoVBaznalQ8Fls31XEj98pZdbGPS4wvovHjg9Tfhf0S5c6xFLiBVoj",
    Pair(2, 2) to "Yfp9eibllZVoVBaznalQ8FFfIK0+1Z+XcDX1tUQ87xBaKVTW0Ajc+Raf5kPPvYq2",
    Pair(3, 0) to "Yfp9eibllZVoVBaznalQ8F6jQtE/BTBI9cwVAvu0ZV3TqJhbOkCf1YIW1P21Gekl5hPN5uSE9Uj5LSWT7cp83Q==",
    Pair(3, 1) to "Yfp9eibllZVoVBaznalQ8LcXV75YfSoSebt1YNIa6e5fyVe10nKb5SP3rOCNx9d939YGnjF2ImtXvlmtVgwWYA==",
    Pair(3, 2) to "Yfp9eibllZVoVBaznalQ8LBeKF1pjdKp4CNIenI6BY53Tpu/dD3391cGaxQQKK/Of1+VHDjPpoaqc7HWwJq82A==",
    ...
    Pair(4, 1) to "",
    Pair(4, 2) to ""
)
...
class AesCryptoServiceTest : StringSpec({
    ...
    "Decryption should fail if the wrong key is provided" {
        AesCryptoService.KeySize.values().forEach { keySizeC ->
            val correctKey = cryptoService.aes.generateKey(keySizeC)
            AesCryptoService.KeySize.values().forEach { keySizeW ->
                val wrongKey = cryptoService.aes.generateKey(keySizeW)
                data.drop(5).forEach { d ->
                    val encrypted = cryptoService.aes.encrypt(d.toByteArray(Charsets.UTF_8), correctKey)
                    shouldThrow<AesDecryptionException> {
                        val decrypted = cryptoService.aes.decrypt(encrypted, wrongKey)
                        decrypted.toList() shouldBe d.toByteArray(Charsets.UTF_8).toList()
                    }
                }
            }
        }
