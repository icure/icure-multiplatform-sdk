...
class AgendaFilters:
	...
	def all(cls) -> BaseFilterOptions[Agenda]:
		call_result = cardinal_sdk.kotlin_types.kotlin.root.com.icure.cardinal.sdk.py.filters.AgendaFilters.all(
		)
	...
	def by_user(cls, user_id: str) -> BaseFilterOptions[Agenda]:
		...
		call_result = cardinal_sdk.kotlin_types.kotlin.root.com.icure.cardinal.sdk.py.filters.AgendaFilters.byUser(
	...
	def readable_by_user(cls, user_id: str) -> BaseFilterOptions[Agenda]:
		...
		call_result = cardinal_sdk.kotlin_types.kotlin.root.com.icure.cardinal.sdk.py.filters.AgendaFilters.readableByUser(
			json.dumps(payload).encode('utf-8')
		)
		result_info = cardinal_sdk.model.CallResult(ctypes(call_result, ctypes).value.decode('utf-8'))
		cardinal_sdk.kotlin_types.DisposeString(call_result)
