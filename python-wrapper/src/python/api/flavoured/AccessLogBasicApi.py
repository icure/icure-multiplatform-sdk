...
from model.AccessLog import EncryptedAccessLog
from model.PaginatedList import PaginatedList

class AccessLogBasicApi:

	def __init__(self, icure_sdk, executor):
		self.native_api = symbols.kotlin.root.com.icure.sdk.py.api.createAccessLogBasicApi()
