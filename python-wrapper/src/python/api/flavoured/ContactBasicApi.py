...
from model.Contact import EncryptedContact
from model.filter.chain.FilterChain import FilterChain
from model.PaginatedList import PaginatedList
from model.embed.Service import EncryptedService

class ContactBasicApi:

	def __init__(self, icure_sdk, executor):
		self.native_api = symbols.kotlin.root.com.icure.sdk.py.api.createContactBasicApi()
