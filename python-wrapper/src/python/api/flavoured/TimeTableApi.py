...
class TimeTableApi:
	...
	async def decrypt_async(self, time_table: EncryptedTimeTable) -> DecryptedTimeTable:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.flavoured.TimeTableApi.decryptAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def decrypt_blocking(self, time_table: EncryptedTimeTable) -> DecryptedTimeTable:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.flavoured.TimeTableApi.decryptBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def try_decrypt_async(self, time_table: EncryptedTimeTable) -> TimeTable:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.flavoured.TimeTableApi.tryDecryptAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def try_decrypt_blocking(self, time_table: EncryptedTimeTable) -> TimeTable:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.flavoured.TimeTableApi.tryDecryptBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
