...
from icure.model import TimeTable, EncryptedTimeTable, DocIdentifier
...
class TimeTableBasicApi:
	...
	async def match_time_tables_by_async(self, filter: BaseFilterOptions[TimeTable]) -> List[str]:
		...
		loop.run_in_executor(
			...
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.matchTimeTablesByAsync,
	...
	def match_time_tables_by_blocking(self, filter: BaseFilterOptions[TimeTable]) -> List[str]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.matchTimeTablesByBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	async def match_time_tables_by_sorted_async(self, filter: BaseSortableFilterOptions[TimeTable]) -> List[str]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.matchTimeTablesBySortedAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def match_time_tables_by_sorted_blocking(self, filter: BaseSortableFilterOptions[TimeTable]) -> List[str]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.matchTimeTablesBySortedBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def filter_time_tables_by_async(self, filter: BaseFilterOptions[TimeTable]) -> PaginatedListIterator[EncryptedTimeTable]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.filterTimeTablesByAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def filter_time_tables_by_blocking(self, filter: BaseFilterOptions[TimeTable]) -> PaginatedListIterator[EncryptedTimeTable]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.filterTimeTablesByBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	async def filter_time_tables_by_sorted_async(self, filter: BaseSortableFilterOptions[TimeTable]) -> PaginatedListIterator[EncryptedTimeTable]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.filterTimeTablesBySortedAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def filter_time_tables_by_sorted_blocking(self, filter: BaseSortableFilterOptions[TimeTable]) -> PaginatedListIterator[EncryptedTimeTable]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.filterTimeTablesBySortedBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		error_str_pointer = symbols.kotlin.root.com.icure.sdk.py.utils.PyResult.get_failure(call_result)
	...
	async def delete_time_table_async(self, entity_id: str) -> DocIdentifier:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.deleteTimeTableAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def delete_time_table_blocking(self, entity_id: str) -> DocIdentifier:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.deleteTimeTableBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def delete_time_tables_async(self, entity_ids: List[str]) -> List[DocIdentifier]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.deleteTimeTablesAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def delete_time_tables_blocking(self, entity_ids: List[str]) -> List[DocIdentifier]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.deleteTimeTablesBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def modify_time_table_async(self, entity: EncryptedTimeTable) -> EncryptedTimeTable:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.modifyTimeTableAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def modify_time_table_blocking(self, entity: EncryptedTimeTable) -> EncryptedTimeTable:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.modifyTimeTableBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_time_table_async(self, entity_id: str) -> EncryptedTimeTable:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.getTimeTableAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def get_time_table_blocking(self, entity_id: str) -> EncryptedTimeTable:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.getTimeTableBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_time_tables_async(self, time_table_ids: List[str]) -> List[EncryptedTimeTable]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.getTimeTablesAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def get_time_tables_blocking(self, time_table_ids: List[str]) -> List[EncryptedTimeTable]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.TimeTableBasicApi.getTimeTablesBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
