...
from icure.model import CalendarItem, EncryptedCalendarItem, DocIdentifier
...
class CalendarItemBasicApi:
	...
	async def match_calendar_items_by_async(self, filter: BaseFilterOptions[CalendarItem]) -> List[str]:
		...
		loop.run_in_executor(
			...
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.matchCalendarItemsByAsync,
	...
	def match_calendar_items_by_blocking(self, filter: BaseFilterOptions[CalendarItem]) -> List[str]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.matchCalendarItemsByBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	async def match_calendar_items_by_sorted_async(self, filter: BaseSortableFilterOptions[CalendarItem]) -> List[str]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.matchCalendarItemsBySortedAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def match_calendar_items_by_sorted_blocking(self, filter: BaseSortableFilterOptions[CalendarItem]) -> List[str]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.matchCalendarItemsBySortedBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def filter_calendar_items_by_async(self, filter: BaseFilterOptions[CalendarItem]) -> PaginatedListIterator[EncryptedCalendarItem]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.filterCalendarItemsByAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def filter_calendar_items_by_blocking(self, filter: BaseFilterOptions[CalendarItem]) -> PaginatedListIterator[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.filterCalendarItemsByBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
	...
	async def filter_calendar_items_by_sorted_async(self, filter: BaseSortableFilterOptions[CalendarItem]) -> PaginatedListIterator[EncryptedCalendarItem]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.filterCalendarItemsBySortedAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def filter_calendar_items_by_sorted_blocking(self, filter: BaseSortableFilterOptions[CalendarItem]) -> PaginatedListIterator[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.filterCalendarItemsBySortedBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		error_str_pointer = symbols.kotlin.root.com.icure.sdk.py.utils.PyResult.get_failure(call_result)
	...
	async def delete_calendar_item_async(self, entity_id: str) -> DocIdentifier:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.deleteCalendarItemAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def delete_calendar_item_blocking(self, entity_id: str) -> DocIdentifier:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.deleteCalendarItemBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def delete_calendar_items_async(self, entity_ids: List[str]) -> List[DocIdentifier]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.deleteCalendarItemsAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def delete_calendar_items_blocking(self, entity_ids: List[str]) -> List[DocIdentifier]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.deleteCalendarItemsBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def modify_calendar_item_async(self, entity: EncryptedCalendarItem) -> EncryptedCalendarItem:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.modifyCalendarItemAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def modify_calendar_item_blocking(self, entity: EncryptedCalendarItem) -> EncryptedCalendarItem:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.modifyCalendarItemBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_calendar_item_async(self, entity_id: str) -> EncryptedCalendarItem:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.getCalendarItemAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def get_calendar_item_blocking(self, entity_id: str) -> EncryptedCalendarItem:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.getCalendarItemBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
	...
	async def get_calendar_items_async(self, entity_ids: List[str]) -> List[EncryptedCalendarItem]:
		...
		loop.run_in_executor(
			self.icure_sdk._executor,
			symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.getCalendarItemsAsync,
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
			callback
		)
	...
	def get_calendar_items_blocking(self, entity_ids: List[str]) -> List[EncryptedCalendarItem]:
		...
		call_result = symbols.kotlin.root.com.icure.sdk.py.api.CalendarItemBasicApi.getCalendarItemsBlocking(
			self.icure_sdk._native,
			json.dumps(payload).encode('utf-8'),
		)
		result_info = create_result_from_json(cast(call_result, c_char_p).value.decode('utf-8'))
