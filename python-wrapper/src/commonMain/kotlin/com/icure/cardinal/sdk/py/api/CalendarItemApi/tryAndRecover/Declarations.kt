...
}.toPyString(SimpleShareResult.serializer(PolymorphicSerializer(CalendarItem::class)))
...
public fun shareWithAsync(
	...
	GlobalScope.launch {
		...
		}.toPyStringAsyncCallback(SimpleShareResult.serializer(PolymorphicSerializer(CalendarItem::class)),
				resultCallback)
	}
