...
}.toPyString(SimpleShareResult.serializer(PolymorphicSerializer(Message::class)))
...
public fun shareWithAsync(
	...
	GlobalScope.launch {
		...
		}.toPyStringAsyncCallback(SimpleShareResult.serializer(PolymorphicSerializer(Message::class)),
				resultCallback)
	}
