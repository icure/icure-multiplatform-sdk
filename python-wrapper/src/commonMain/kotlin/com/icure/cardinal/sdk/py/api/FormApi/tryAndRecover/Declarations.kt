...
}.toPyString(SimpleShareResult.serializer(PolymorphicSerializer(Form::class)))
...
public fun shareWithAsync(
	...
	GlobalScope.launch {
		...
		}.toPyStringAsyncCallback(SimpleShareResult.serializer(PolymorphicSerializer(Form::class)),
				resultCallback)
	}
