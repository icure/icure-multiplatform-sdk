...
}.toPyString(SimpleShareResult.serializer(PolymorphicSerializer(AccessLog::class)))
...
public fun shareWithAsync(
	...
	GlobalScope.launch {
		...
		}.toPyStringAsyncCallback(SimpleShareResult.serializer(PolymorphicSerializer(AccessLog::class)),
				resultCallback)
	}
...
public fun findAccessLogsByHcPartyPatientBlocking(sdk: CardinalApis, params: String): PyResult =
	...
	PaginatedListIteratorAndSerializer(it, PolymorphicSerializer(AccessLog::class))}
...
}.toPyString(PaginatedList.serializer(PolymorphicSerializer(AccessLog::class)))
...
public fun findAccessLogsByAsync(
	...
	GlobalScope.launch {
		...
		}.toPyStringAsyncCallback(PaginatedList.serializer(PolymorphicSerializer(AccessLog::class)),
				resultCallback)
	}
}.failureToPyStringAsyncCallback(resultCallback)
