// auto-generated file
package com.icure.sdk.py.api.flavoured.ContactBasicApi
...
public fun subscribeToServiceEventsBlocking(sdk: IcureBaseApis, params: String): PyResult =
		kotlin.runCatching {
...
public fun filterContactsByBlocking(sdk: IcureBaseApis, params: String): String =
		kotlin.runCatching {
...
public fun closeForHCPartyPatientForeignKeysBlocking(sdk: IcureBaseApis, params: String): String =
		kotlin.runCatching {
...
public fun filterServicesByBlocking(sdk: IcureBaseApis, params: String): String =
		kotlin.runCatching {
...
}.toPyString(PaginatedList.serializer(EncryptedService.serializer()))
...
public fun filterServicesByAsync(
	...
	GlobalScope.launch {
		...
		}.toPyStringAsyncCallback(PaginatedList.serializer(EncryptedService.serializer()), resultCallback)
	}
}.failureToPyStringAsyncCallback(resultCallback)
