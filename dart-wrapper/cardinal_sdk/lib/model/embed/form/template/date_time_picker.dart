...
@freezed
abstract class DateTimePicker with _$DateTimePicker implements Field {
	const factory DateTimePicker({
	...
	static Map<String, dynamic> encode(DateTimePicker value) {
	...
	static DateTimePicker fromJSON(Map<String, dynamic> data) {
