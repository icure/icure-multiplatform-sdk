...
mixin _$DatePicker {
  ...
  /// Create a copy of DatePicker
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $DatePickerCopyWith<DatePicker> get copyWith =>
      _$DatePickerCopyWithImpl<DatePicker>(this as DatePicker, _$identity);
  ...
  @override
  String toString() {
    return 'DatePicker(field: $field, shortLabel: $shortLabel, rows: $rows, columns: $columns, grows: $grows, multiline: $multiline, schema: $schema, tags: $tags, codifications: $codifications, options: $options, labels: $labels, value: $value, unit: $unit, required: $required, hideCondition: $hideCondition, now: $now, translate: $translate)';
  }
}

/// @nodoc
abstract mixin class $DatePickerCopyWith<$Res> {
  factory $DatePickerCopyWith(
          DatePicker value, $Res Function(DatePicker) _then) =
      _$DatePickerCopyWithImpl;
  @useResult
  $Res call(
      {String field,
      String? shortLabel,
...
/// @nodoc
class _$DatePickerCopyWithImpl<$Res> implements $DatePickerCopyWith<$Res> {
  _$DatePickerCopyWithImpl(this._self, this._then);

  final DatePicker _self;
  final $Res Function(DatePicker) _then;
...
class _DatePicker implements DatePicker {
  const _DatePicker(
      {required this.field,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DatePickerCopyWith<_DatePicker> get copyWith =>
      __$DatePickerCopyWithImpl<_DatePicker>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DatePicker &&
            (identical(other.field, field) || other.field == field) &&
            (identical(other.shortLabel, shortLabel) ||
                other.shortLabel == shortLabel) &&
            (identical(other.rows, rows) || other.rows == rows) &&
...
/// @nodoc
abstract mixin class _$DatePickerCopyWith<$Res>
    implements $DatePickerCopyWith<$Res> {
  factory _$DatePickerCopyWith(
          _DatePicker value, $Res Function(_DatePicker) _then) =
      __$DatePickerCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String field,
...
/// @nodoc
class __$DatePickerCopyWithImpl<$Res> implements _$DatePickerCopyWith<$Res> {
  __$DatePickerCopyWithImpl(this._self, this._then);

  final _DatePicker _self;
  final $Res Function(_DatePicker) _then;
