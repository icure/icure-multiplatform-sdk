...
mixin _$DropdownField {
  ...
  /// Create a copy of DropdownField
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $DropdownFieldCopyWith<DropdownField> get copyWith =>
      _$DropdownFieldCopyWithImpl<DropdownField>(
          this as DropdownField, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DropdownField &&
  ...
  @override
  String toString() {
    return 'DropdownField(field: $field, shortLabel: $shortLabel, rows: $rows, columns: $columns, grows: $grows, multiline: $multiline, schema: $schema, tags: $tags, codifications: $codifications, options: $options, labels: $labels, value: $value, unit: $unit, required: $required, hideCondition: $hideCondition, now: $now, translate: $translate)';
  }
}

/// @nodoc
abstract mixin class $DropdownFieldCopyWith<$Res> {
  factory $DropdownFieldCopyWith(
          DropdownField value, $Res Function(DropdownField) _then) =
      _$DropdownFieldCopyWithImpl;
  @useResult
  $Res call(
      {String field,
      String? shortLabel,
...
/// @nodoc
class _$DropdownFieldCopyWithImpl<$Res>
    implements $DropdownFieldCopyWith<$Res> {
  _$DropdownFieldCopyWithImpl(this._self, this._then);

  final DropdownField _self;
  final $Res Function(DropdownField) _then;
...
class _DropdownField implements DropdownField {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DropdownFieldCopyWith<_DropdownField> get copyWith =>
      __$DropdownFieldCopyWithImpl<_DropdownField>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DropdownField &&
            (identical(other.field, field) || other.field == field) &&
            (identical(other.shortLabel, shortLabel) ||
                other.shortLabel == shortLabel) &&
            (identical(other.rows, rows) || other.rows == rows) &&
...
/// @nodoc
abstract mixin class _$DropdownFieldCopyWith<$Res>
    implements $DropdownFieldCopyWith<$Res> {
  factory _$DropdownFieldCopyWith(
          _DropdownField value, $Res Function(_DropdownField) _then) =
      __$DropdownFieldCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String field,
...
/// @nodoc
class __$DropdownFieldCopyWithImpl<$Res>
    implements _$DropdownFieldCopyWith<$Res> {
  __$DropdownFieldCopyWithImpl(this._self, this._then);

  final _DropdownField _self;
  final $Res Function(_DropdownField) _then;
