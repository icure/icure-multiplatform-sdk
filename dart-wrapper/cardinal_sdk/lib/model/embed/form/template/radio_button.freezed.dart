...
mixin _$RadioButton {
  ...
  /// Create a copy of RadioButton
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RadioButtonCopyWith<RadioButton> get copyWith =>
      _$RadioButtonCopyWithImpl<RadioButton>(this as RadioButton, _$identity);
  ...
  @override
  String toString() {
    return 'RadioButton(field: $field, shortLabel: $shortLabel, rows: $rows, columns: $columns, grows: $grows, multiline: $multiline, schema: $schema, tags: $tags, codifications: $codifications, options: $options, labels: $labels, value: $value, unit: $unit, required: $required, hideCondition: $hideCondition, now: $now, translate: $translate)';
  }
}

/// @nodoc
abstract mixin class $RadioButtonCopyWith<$Res> {
  factory $RadioButtonCopyWith(
          RadioButton value, $Res Function(RadioButton) _then) =
      _$RadioButtonCopyWithImpl;
  @useResult
  $Res call(
      {String field,
      String? shortLabel,
...
/// @nodoc
class _$RadioButtonCopyWithImpl<$Res> implements $RadioButtonCopyWith<$Res> {
  _$RadioButtonCopyWithImpl(this._self, this._then);

  final RadioButton _self;
  final $Res Function(RadioButton) _then;
...
class _RadioButton implements RadioButton {
  const _RadioButton(
      {required this.field,
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RadioButtonCopyWith<_RadioButton> get copyWith =>
      __$RadioButtonCopyWithImpl<_RadioButton>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _RadioButton &&
            (identical(other.field, field) || other.field == field) &&
            (identical(other.shortLabel, shortLabel) ||
                other.shortLabel == shortLabel) &&
            (identical(other.rows, rows) || other.rows == rows) &&
...
/// @nodoc
abstract mixin class _$RadioButtonCopyWith<$Res>
    implements $RadioButtonCopyWith<$Res> {
  factory _$RadioButtonCopyWith(
          _RadioButton value, $Res Function(_RadioButton) _then) =
      __$RadioButtonCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String field,
...
/// @nodoc
class __$RadioButtonCopyWithImpl<$Res> implements _$RadioButtonCopyWith<$Res> {
  __$RadioButtonCopyWithImpl(this._self, this._then);

  final _RadioButton _self;
  final $Res Function(_RadioButton) _then;
