...
part "number_field.freezed.dart";


@freezed
abstract class NumberField with _$NumberField implements Field {
	const factory NumberField({
	...
	static Map<String, dynamic> encode(NumberField value) {
	...
	static NumberField fromJSON(Map<String, dynamic> data) {
		return NumberField(
