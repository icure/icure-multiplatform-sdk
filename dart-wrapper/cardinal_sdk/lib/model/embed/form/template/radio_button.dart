...
part "radio_button.freezed.dart";


@freezed
abstract class RadioButton with _$RadioButton implements Field {
	...
	static Map<String, dynamic> encode(RadioButton value) {
	...
	static RadioButton fromJSON(Map<String, dynamic> data) {
		return RadioButton(
