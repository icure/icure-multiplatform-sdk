...
part "dropdown_field.freezed.dart";


@freezed
abstract class DropdownField with _$DropdownField implements Field {
	...
	static DropdownField fromJSON(Map<String, dynamic> data) {
