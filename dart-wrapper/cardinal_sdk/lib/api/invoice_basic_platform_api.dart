...
class InvoiceBasicPlatformApi {
	...
	Future<DocIdentifier> deleteInvoice(String entityId) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.deleteInvoice(
			_sdkId,
			entityId,
		);
	}
	...
	Future<List<IcureStub>> findInvoicesDelegationsStubsByHcPartyPatientForeignKeys(String hcPartyId, List<String> secretPatientKeys) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.findInvoicesDelegationsStubsByHcPartyPatientForeignKeys(
			_sdkId,
			hcPartyId,
			secretPatientKeys,
		);
	...
	Future<List<LabelledOccurence>> getTarificationsCodesOccurrences(int minOccurrence) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.getTarificationsCodesOccurrences(
			_sdkId,
			minOccurrence,
		);
	}
	...
	Future<EncryptedInvoice> modifyInvoice(EncryptedInvoice entity) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.modifyInvoice(
			_sdkId,
			entity,
		);
	}
	...
	Future<List<EncryptedInvoice>> modifyInvoices(List<EncryptedInvoice> entities) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.modifyInvoices(
			_sdkId,
			entities,
		);
	}
	...
	Future<EncryptedInvoice> getInvoice(String entityId) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.getInvoice(
			_sdkId,
			entityId,
		);
	}
	...
	Future<List<EncryptedInvoice>> getInvoices(List<String> entityIds) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.getInvoices(
			_sdkId,
			entityIds,
		);
	}
	...
	Future<List<EncryptedInvoice>> findInvoicesByHcPartyPatientForeignKeys(String hcPartyId, List<String> secretPatientKeys) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.findInvoicesByHcPartyPatientForeignKeys(
			_sdkId,
			hcPartyId,
			secretPatientKeys,
		);
	...
	Future<EncryptedInvoice> reassignInvoice(EncryptedInvoice invoice) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.reassignInvoice(
			_sdkId,
			invoice,
		);
	}
	...
	Future<EncryptedInvoice> mergeTo(String invoiceId, List<String> ids) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.mergeTo(
			_sdkId,
			invoiceId,
			ids,
		);
	...
	Future<EncryptedInvoice> validate(String invoiceId, String scheme, String forcedValue) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.validate(
			_sdkId,
			invoiceId,
			scheme,
			forcedValue,
	...
	Future<List<EncryptedInvoice>> removeCodes(String userId, String serviceId, String secretFKeys, List<String> tarificationIds) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.removeCodes(
			_sdkId,
			userId,
			serviceId,
			secretFKeys,
	...
	Future<List<EncryptedInvoice>> listInvoicesByHCPartyAndPatientForeignKeys(String hcPartyId, List<String> secretPatientKeys) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listInvoicesByHCPartyAndPatientForeignKeys(
			_sdkId,
			hcPartyId,
			secretPatientKeys,
		);
	...
	Future<List<EncryptedInvoice>> listInvoicesByHcPartyAndGroupId(String hcPartyId, String groupId) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listInvoicesByHcPartyAndGroupId(
			_sdkId,
			hcPartyId,
			groupId,
		);
	...
	Future<List<EncryptedInvoice>> listInvoicesByContactIds(List<String> contactIds) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listInvoicesByContactIds(
			_sdkId,
			contactIds,
		);
	}
	...
	Future<List<EncryptedInvoice>> listInvoicesByRecipientsIds(List<String> recipientsIds) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listInvoicesByRecipientsIds(
			_sdkId,
			recipientsIds,
		);
	}
	...
	Future<List<EncryptedInvoice>> listToInsurances(List<String> userIds) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listToInsurances(
			_sdkId,
			userIds,
		);
	}
	...
	Future<List<EncryptedInvoice>> listToInsurancesUnsent(List<String> userIds) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listToInsurancesUnsent(
			_sdkId,
			userIds,
		);
	}
	...
	Future<List<EncryptedInvoice>> listToPatients(String hcPartyId) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listToPatients(
			_sdkId,
			hcPartyId,
		);
	}
	...
	Future<List<EncryptedInvoice>> listToPatientsUnsent(String? hcPartyId) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listToPatientsUnsent(
			_sdkId,
			hcPartyId,
		);
	}
	...
	Future<List<EncryptedInvoice>> listInvoicesByIds(List<String> ids) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listInvoicesByIds(
			_sdkId,
			ids,
		);
	}
	...
	Future<List<EncryptedInvoice>> listInvoicesByHcpartySendingModeStatusDate(String hcPartyId, String sendingMode, String status, int from, int to) async {
		return await CardinalSdkPlatformInterface.instance.invoiceBasic.listInvoicesByHcpartySendingModeStatusDate(
			_sdkId,
			hcPartyId,
			sendingMode,
			status,
