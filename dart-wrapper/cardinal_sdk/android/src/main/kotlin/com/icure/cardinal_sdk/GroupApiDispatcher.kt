...
public object GroupApiDispatcher {
  public fun dispatch(
    ...
    "findGroups" -> findGroups(parameters, resultCallback)
    "findGroupsWithContent" -> findGroupsWithContent(parameters, resultCallback)
  ...
  private fun findGroups(parameters: Map<String, String>, resultCallback: (
    String?,
    String?,
    String?,
  ) -> Unit) {
  ...
  private fun findGroupsWithContent(parameters: Map<String, String>, resultCallback: (
    String?,
    String?,
    String?,
  ) -> Unit) {
