...
public object InvoiceApiDispatcher {
  public fun dispatch(
    ...
    "findInvoicesByAuthor" -> findInvoicesByAuthor(parameters, resultCallback)
    ...
    "encrypted.findInvoicesByAuthor" -> encrypted_findInvoicesByAuthor(parameters, resultCallback)
    ...
    "tryAndRecover.findInvoicesByAuthor" -> tryAndRecover_findInvoicesByAuthor(parameters, resultCallback)
  ...
  private fun findInvoicesByAuthor(parameters: Map<String, String>, resultCallback: (
    String?,
    String?,
    String?,
  ) -> Unit) {
  ...
  private fun encrypted_findInvoicesByAuthor(parameters: Map<String, String>, resultCallback: (
    String?,
    String?,
    String?,
  ) -> Unit) {
  ...
  private fun tryAndRecover_findInvoicesByAuthor(parameters: Map<String, String>, resultCallback: (
    String?,
    String?,
    String?,
  ) -> Unit) {
