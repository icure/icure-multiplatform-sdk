...
public object MedicalLocationApi {
  public fun createMedicalLocation(
    ...
    ApiScope.execute(
      dartResultCallback,
      MedicalLocation.serializer()) {
      NativeReferences.get<CardinalApis>(sdkId).medicalLocation.createMedicalLocation(
        medicalLocationDto,
      )
    }
  }
  ...
  public fun deleteMedicalLocations(
    ...
    ApiScope.execute(
      ...
      NativeReferences.get<CardinalApis>(sdkId).medicalLocation.deleteMedicalLocations(
        locationIds,
      )
    }
  }
  ...
  public fun getMedicalLocation(
    ...
    ApiScope.execute(
      dartResultCallback,
      MedicalLocation.serializer()) {
      NativeReferences.get<CardinalApis>(sdkId).medicalLocation.getMedicalLocation(
        locationId,
      )
    }
  }
  ...
  public fun modifyMedicalLocation(
    ...
    ApiScope.execute(
      dartResultCallback,
      MedicalLocation.serializer()) {
      NativeReferences.get<CardinalApis>(sdkId).medicalLocation.modifyMedicalLocation(
        medicalLocationDto,
      )
    }
  }
  ...
  public fun getMedicalLocations(
    ...
    ApiScope.execute(
      ...
      NativeReferences.get<CardinalApis>(sdkId).medicalLocation.getMedicalLocations(
        medicalLocationIds,
      )
    }
  }
  ...
  public fun matchMedicalLocationsBy(
    ...
    ApiScope.execute(
      dartResultCallback,
      ListSerializer(String.serializer())) {
      NativeReferences.get<CardinalApis>(sdkId).medicalLocation.matchMedicalLocationsBy(
        filter,
      )
    }
  }
  ...
  public fun matchMedicalLocationsBySorted(
    ...
    ApiScope.execute(
      dartResultCallback,
      ListSerializer(String.serializer())) {
      NativeReferences.get<CardinalApis>(sdkId).medicalLocation.matchMedicalLocationsBySorted(
        filter,
      )
    }
  }
  ...
  public fun filterMedicalLocationsBy(
    ...
    ApiScope.execute(
      ...
      String.serializer()) {
      val richResult =
          NativeReferences.get<CardinalApis>(sdkId).medicalLocation.filterMedicalLocationsBy(
        filter,
      )
  ...
  public fun filterMedicalLocationsBySorted(
    ...
    ApiScope.execute(
      ...
      String.serializer()) {
      val richResult =
          NativeReferences.get<CardinalApis>(sdkId).medicalLocation.filterMedicalLocationsBySorted(
        filter,
      )
      NativeReferences.create(PaginatedListIteratorWithSerializer(
        richResult,
