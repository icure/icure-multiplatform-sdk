...
public object KeywordApi {
  public fun getKeyword(
    ...
    ApiScope.execute(
      dartResultCallback,
      Keyword.serializer()) {
      NativeReferences.get<CardinalApis>(sdkId).keyword.getKeyword(
        frontEndMigrationId,
      )
    }
  }
  ...
  public fun createKeyword(
    ...
    ApiScope.execute(
      dartResultCallback,
      Keyword.serializer()) {
      NativeReferences.get<CardinalApis>(sdkId).keyword.createKeyword(
        frontEndMigration,
      )
    }
  }
  ...
  public fun modifyKeyword(
    ...
    ApiScope.execute(
      dartResultCallback,
      Keyword.serializer()) {
      NativeReferences.get<CardinalApis>(sdkId).keyword.modifyKeyword(
        keyword,
      )
    }
  }
  ...
  public fun getKeywordsByUser(
    ...
    ApiScope.execute(
      ...
      NativeReferences.get<CardinalApis>(sdkId).keyword.getKeywordsByUser(
        userId,
      )
    }
  }
  ...
  public fun deleteKeywords(
    ...
    ApiScope.execute(
      ...
      NativeReferences.get<CardinalApis>(sdkId).keyword.deleteKeywords(
        keywordIds,
      )
    }
  }
