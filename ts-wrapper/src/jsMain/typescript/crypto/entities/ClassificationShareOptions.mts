...
export class ClassificationShareOptions implements SimpleDelegateShareOptions {
  ...
  constructor(partial: Partial<ClassificationShareOptions> & Pick<ClassificationShareOptions, "requestedPermissions" | "shareEncryptionKey" | "sharePatientId" | "shareOwningEntityIds" | "shareSecretIds">) {
