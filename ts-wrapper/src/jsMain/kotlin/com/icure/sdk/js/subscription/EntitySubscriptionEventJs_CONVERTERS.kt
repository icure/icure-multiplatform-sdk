...
public fun <E : IdentifiableJs<String>, E_KT : Identifiable<String>>
	...
	obj is EntitySubscriptionEventJs_ConnectedJs || obj.ktClass ==
			"com.icure.sdk.subscription.EntitySubscriptionEvent.Connected" ->entitySubscriptionEvent_Connected_fromJs(obj
			as com.icure.sdk.js.subscription.EntitySubscriptionEventJs_ConnectedJs) as
			EntitySubscriptionEvent<E_KT>
	obj is EntitySubscriptionEventJs_ReconnectedJs || obj.ktClass ==
			"com.icure.sdk.subscription.EntitySubscriptionEvent.Reconnected" ->entitySubscriptionEvent_Reconnected_fromJs(obj
			as com.icure.sdk.js.subscription.EntitySubscriptionEventJs_ReconnectedJs) as
			EntitySubscriptionEvent<E_KT>
	obj is EntitySubscriptionEventJs_UnexpectedErrorJs || obj.ktClass ==
			"com.icure.sdk.subscription.EntitySubscriptionEvent.UnexpectedError" ->entitySubscriptionEvent_UnexpectedError_fromJs(obj
			as com.icure.sdk.js.subscription.EntitySubscriptionEventJs_UnexpectedErrorJs) as
			EntitySubscriptionEvent<E_KT>
	obj is EntitySubscriptionEventJs_ConnectionErrorJs_MissedPingJs || obj.ktClass ==
			"com.icure.sdk.subscription.EntitySubscriptionEvent.ConnectionError.MissedPing" ->entitySubscriptionEvent_ConnectionError_MissedPing_fromJs(obj
			as com.icure.sdk.js.subscription.EntitySubscriptionEventJs_ConnectionErrorJs_MissedPingJs) as
			EntitySubscriptionEvent<E_KT>
	obj is EntitySubscriptionEventJs_ConnectionErrorJs_ClosedByServerJs || obj.ktClass ==
			"com.icure.sdk.subscription.EntitySubscriptionEvent.ConnectionError.ClosedByServer" ->entitySubscriptionEvent_ConnectionError_ClosedByServer_fromJs(obj
			as com.icure.sdk.js.subscription.EntitySubscriptionEventJs_ConnectionErrorJs_ClosedByServerJs) as
			EntitySubscriptionEvent<E_KT>
	obj is EntitySubscriptionEventJs_EntityNotificationJs<E> || obj.ktClass ==
			"com.icure.sdk.subscription.EntitySubscriptionEvent.EntityNotification" ->entitySubscriptionEvent_EntityNotification_fromJs(
		obj as com.icure.sdk.js.subscription.EntitySubscriptionEventJs_EntityNotificationJs<E>,
		{ x1: E ->
			convertE(x1)
		},
	) as EntitySubscriptionEvent<E_KT>
	obj is EntitySubscriptionEventJs_EntityErrorJs_DeserializationErrorJs || obj.ktClass ==
			"com.icure.sdk.subscription.EntitySubscriptionEvent.EntityError.DeserializationError" ->entitySubscriptionEvent_EntityError_DeserializationError_fromJs(obj
			as com.icure.sdk.js.subscription.EntitySubscriptionEventJs_EntityErrorJs_DeserializationErrorJs)
			as EntitySubscriptionEvent<E_KT>
	else -> throw
			IllegalArgumentException("""Unknown concrete implementation for com.icure.sdk.subscription.EntitySubscriptionEvent: $obj""")
}
