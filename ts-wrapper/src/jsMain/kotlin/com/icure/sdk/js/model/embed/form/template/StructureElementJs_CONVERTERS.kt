...
public fun structureElement_fromJs(obj: StructureElementJs): StructureElement = when {
	obj is DropdownFieldJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.DropdownField" ->dropdownField_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.DropdownFieldJs)
	obj is RadioButtonJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.RadioButton" ->radioButton_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.RadioButtonJs)
	obj is DatePickerJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.DatePicker" ->datePicker_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.DatePickerJs)
	obj is TimePickerJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.TimePicker" ->timePicker_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.TimePickerJs)
	obj is DateTimePickerJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.DateTimePicker" ->dateTimePicker_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.DateTimePickerJs)
	obj is NumberFieldJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.NumberField" ->numberField_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.NumberFieldJs)
	obj is TextFieldJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.TextField" ->textField_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.TextFieldJs)
	obj is CheckBoxJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.CheckBox" ->checkBox_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.CheckBoxJs)
	obj is MultipleChoiceJs || obj.ktClass ==
			"com.icure.sdk.model.embed.form.template.MultipleChoice" ->multipleChoice_fromJs(obj as
			com.icure.sdk.js.model.embed.form.template.MultipleChoiceJs)
