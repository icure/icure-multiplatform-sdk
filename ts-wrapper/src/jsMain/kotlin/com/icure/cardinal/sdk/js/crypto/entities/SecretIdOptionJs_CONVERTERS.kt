...
public fun secretIdOption_fromJs(obj: SecretIdOptionJs): SecretIdOption = when {
	obj is SecretIdOptionJs_UseAnyConfidentialJs || obj.ktClass ==
			"com.icure.cardinal.sdk.crypto.entities.SecretIdOption.UseAnyConfidential" ->secretIdOption_UseAnyConfidential_fromJs(obj
			as com.icure.cardinal.sdk.js.crypto.entities.SecretIdOptionJs_UseAnyConfidentialJs)
	obj is SecretIdOptionJs_UseAnySharedWithParentJs || obj.ktClass ==
			"com.icure.cardinal.sdk.crypto.entities.SecretIdOption.UseAnySharedWithParent" ->secretIdOption_UseAnySharedWithParent_fromJs(obj
			as com.icure.cardinal.sdk.js.crypto.entities.SecretIdOptionJs_UseAnySharedWithParentJs)
	obj is SecretIdOptionJs_UseJs || obj.ktClass ==
			"com.icure.cardinal.sdk.crypto.entities.SecretIdOption.Use" ->secretIdOption_Use_fromJs(obj as
			com.icure.cardinal.sdk.js.crypto.entities.SecretIdOptionJs_UseJs)
	else -> throw
			IllegalArgumentException("""Unknown concrete implementation for com.icure.cardinal.sdk.crypto.entities.SecretIdOption: $obj""")
}
