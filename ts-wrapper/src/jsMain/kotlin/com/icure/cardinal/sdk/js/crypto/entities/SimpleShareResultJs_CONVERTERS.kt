...
public fun <T : HasEncryptionMetadataJs, T_KT : HasEncryptionMetadata>
	...
	obj is SimpleShareResultJs_SuccessJs<T> || obj.ktClass ==
			"com.icure.cardinal.sdk.crypto.entities.SimpleShareResult.Success" ->simpleShareResult_Success_fromJs(
		obj as com.icure.cardinal.sdk.js.crypto.entities.SimpleShareResultJs_SuccessJs<T>,
		{ x1: T ->
			convertT(x1)
		},
	) as SimpleShareResult<T_KT>
	obj is SimpleShareResultJs_FailureJs || obj.ktClass ==
			"com.icure.cardinal.sdk.crypto.entities.SimpleShareResult.Failure" ->simpleShareResult_Failure_fromJs(obj
			as com.icure.cardinal.sdk.js.crypto.entities.SimpleShareResultJs_FailureJs) as
			SimpleShareResult<T_KT>
	else -> throw
			IllegalArgumentException("""Unknown concrete implementation for com.icure.cardinal.sdk.crypto.entities.SimpleShareResult: $obj""")
}
