...
public
	...
	obj is ShareAllPatientDataOptionsJs_BulkShareFailureJs || obj.ktClass ==
			"com.icure.cardinal.sdk.crypto.entities.ShareAllPatientDataOptions.BulkShareFailure" ->shareAllPatientDataOptions_BulkShareFailure_fromJs(obj
			as com.icure.cardinal.sdk.js.crypto.entities.ShareAllPatientDataOptionsJs_BulkShareFailureJs)
	obj is ShareAllPatientDataOptionsJs_FailedRequestJs || obj.ktClass ==
			"com.icure.cardinal.sdk.crypto.entities.ShareAllPatientDataOptions.FailedRequest" ->shareAllPatientDataOptions_FailedRequest_fromJs(obj
			as com.icure.cardinal.sdk.js.crypto.entities.ShareAllPatientDataOptionsJs_FailedRequestJs)
	else -> throw
			IllegalArgumentException("""Unknown concrete implementation for com.icure.cardinal.sdk.crypto.entities.ShareAllPatientDataOptions.SharePatientDataError: $obj""")
}
