...
@JsExport
public object InternalClassificationFiltersObj {
	public fun byPatientsCreatedForDataOwner(
		dataOwnerId: String,
		patients: Array<PatientJs>,
		options: dynamic,
	): SortableFilterOptionsJs<ClassificationJs> {
		...
		val result = ClassificationFilters.byPatientsCreatedForDataOwner(
	...
	public fun byPatientsCreatedForSelf(patients: Array<PatientJs>, options: dynamic):
		...
		val result = ClassificationFilters.byPatientsCreatedForSelf(
			patientsConverted,
			fromConverted,
			toConverted,
			descendingConverted,
	...
	public fun byPatientSecretIdsCreatedForDataOwner(
		...
		options: dynamic,
	): BaseSortableFilterOptionsJs<ClassificationJs> {
		val _options = options ?: js("{}")
		val dataOwnerIdConverted: String = dataOwnerId
		...
		val result = ClassificationFilters.byPatientSecretIdsCreatedForDataOwner(
			dataOwnerIdConverted,
			secretIdsConverted,
			fromConverted,
			toConverted,
	...
	public fun byPatientSecretIdsCreatedForSelf(secretIds: Array<String>, options: dynamic):
		...
		val result = ClassificationFilters.byPatientSecretIdsCreatedForSelf(
			secretIdsConverted,
			fromConverted,
			toConverted,
			descendingConverted,
